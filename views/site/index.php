        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <p><a class="btn btn-default"
                      href="<?php echo Url::toRoute(['site/questions', 'type' => 'kollok']); ?>">Создать &raquo;</a></p>
            </div>
            <div class="col-lg-4">
                <h2>Контрольная работа</h2>
                <p>Список задач для проведения контрольной по одной или нескольким темам, или по всему курсу</p>
                <p><a class="btn btn-default" href="<?php echo Url::toRoute(['site/questions', 'type' => 'kr']); ?>">Создать
                        &raquo;</a></p>
            </div>
            <div class="col-lg-4">
                <h2>Экзамен</h2>
                <p>Билеты к экзамену, состоящие из двух теоретических вопросов и одной задачи</p>
                <p><a class="btn btn-default" href="<?php echo Url::toRoute(['site/questions', 'type' => 'ekz']); ?>">Создать
                        &raquo;</a></p>
            </div>
        </div>
